#ifndef _DRIVE_MACHINE_H
	#define _DRIVE_MACHINE_H
...
//	}SAllDriveConditionParam;	//parametry wykorzystywane przy przejazdach warunkowych
	...
	class defODriveMachine{
		...
		public:
			defODriveMachine(vector<defOMotorDriver*> *motors);
			...
			virtual void setParToDriveToPhyCoordinates(vector<int>*) =0;
			virtual void setParToDriveToCharacteristicPoint() =0;
			virtual void setParToDriveToLimstop() =0;
