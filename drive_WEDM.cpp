...
void defODriveWEDM::driveForValue(){
	...
	driveParam->pointB.X.value=oCoordinates->phyCoord.X.value+oCoordinates->auxCoord.X.value;
	driveParam->pointB.Y.value=oCoordinates->phyCoord.Y.value+oCoordinates->auxCoord.Y.value;
	driveParam->pointB.Z.value=oCoordinates->phyCoord.Z.value+oCoordinates->auxCoord.Z.value;
	driveParam->pointB.U.value=oCoordinates->phyCoord.U.value+oCoordinates->auxCoord.U.value;
	driveParam->pointB.V.value=oCoordinates->phyCoord.V.value+oCoordinates->auxCoord.V.value;
	driveParam->pointB.Zw.value=oCoordinates->phyCoord.Zw.value+oCoordinates->auxCoord.Zw.value;
...
static int32_t driveToBaseCoordinates(defOCoordinates *oCoordinates, defOCheckSignals* oCheckSignalsLimitedStop, SDriveParam *driveParam, int32_t *infoDrive, defOMenu *oMenu, 
	...
	driveParam->pointB.X.value=oCoordinates->phyCoord.X.value+(oCoordinates->auxCoord.X.value-oCoordinates->baseCoord.X.value);
	driveParam->pointB.Y.value=oCoordinates->phyCoord.Y.value+(oCoordinates->auxCoord.Y.value-oCoordinates->baseCoord.Y.value);
	driveParam->pointB.Z.value=oCoordinates->phyCoord.Z.value+(oCoordinates->auxCoord.Z.value-oCoordinates->baseCoord.Z.value);
	driveParam->pointB.U.value=oCoordinates->phyCoord.U.value+(oCoordinates->auxCoord.U.value-oCoordinates->baseCoord.U.value);
	driveParam->pointB.V.value=oCoordinates->phyCoord.V.value+(oCoordinates->auxCoord.V.value-oCoordinates->baseCoord.V.value);
	driveParam->pointB.Zw.value=oCoordinates->phyCoord.Zw.value+(oCoordinates->auxCoord.Zw.value-oCoordinates->baseCoord.Zw.value);
